...
export namespace IPFS {
    function tryCat(ipfsPath: string): Result<Array<u8>> {
    ...
    function tryAdd(content: Array<u8>): Result<string> {
    ...
    function cat(ipfsPath: string): Array<u8> {
    ...
    function add(content: Array<u8>): string {
