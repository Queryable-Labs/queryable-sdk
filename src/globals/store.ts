...
export function trySave(entity: Entity): Result<BooleanValue> {
...
export function tryLoad<T>(name: string, id: u64): Result<T> {
    const nameValue = new StringValue(false);
...
export function tryLoadReference<T>(name: string, id: u64): Result<T> {
    const nameValue = new StringValue(false);
    nameValue.value = name;
...
export function tryGetNextId(name: string): Result<UInt64Value> {
    const nameValue = new StringValue(false);
    nameValue.value = name;
...
export function save(entity: Entity): boolean {
...
export function load<T>(name: string, id: u64): T {
...
export function loadReference<T>(name: string, id: u64): T {
...
export function getNextId(name: string): u64 {
